...
class MemoryQueryClientTest {
    ...
    void aggregate() {
        ...
        assertThat(testViews).hasSize(4).contains(
                new EmployeeView("dep1", "male", "des1", 90000, 4500, 15.0, 100000, 80000),
                new EmployeeView("dep1", "female", "des2", 70000, 3000, 13.0, 70000, 70000),
                new EmployeeView("dep1", "female", "des1", 80000, 4000, 10.0, 80000, 80000),
                new EmployeeView("dep2", "male", "des1", 65000, 3250, 15.5, 70000, 60000)
        );
